...
def german_credit():
    ...
    german_credit.sample_transformations["quartic"] = model.Model.SampleTransformation(
        fn=lambda params: german_credit.sample_transformations["identity"](params)
        ** 4,
        pretty_name="Quartic",
    ...
    german_credit.sample_transformations["covariance"] = (
        model.Model.SampleTransformation(
            fn=lambda params: jnp.outer(german_credit.sample_transformations["identity"](params) - e_x, german_credit.sample_transformations["identity"](params) - e_x),
