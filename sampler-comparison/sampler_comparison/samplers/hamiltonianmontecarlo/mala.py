...
def adjusted_overdamped_no_tuning(
    initial_state,
    integrator_type,
    step_size,
    L,
    ...
    def s(model, num_steps, initial_position, key):
        ...
        # integration_steps_fn = lambda a, num_steps_per_traj: 1
...
def adjusted_overdamped(
    ...
    def s(model, num_steps, initial_position, key):
        ...
        expectations, metadata = adjusted_overdamped_no_tuning(
            initial_state=state,
