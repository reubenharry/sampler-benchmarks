...
def grid_search_unadjusted_hmc(
    ...
    """
    Cleaner and more principled grid search for unadjusted HMC with ALBA warmup.
    ...
    def s(model, num_steps, initial_position, key):
        ...
        optimal_L, optimal_step_size, optimal_value, all_values, optimal_idx, tuning_outcome = grid_search_L(
            ...
            sampler_fn=unadjusted_hmc_no_tuning,
            algorithm=blackjax.uhmc,  # Pass algorithm directly
