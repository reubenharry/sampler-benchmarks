...
if __name__ == "__main__":
  ...
  # for time in [3.0]:
    ...
    np.save(f'{dir}/samples_np_flat_quadratic_{time}_{burn_in}_{num_unadjusted_steps}_{numsteps}_{j_r}.npy', samples_np)
    np.save(f'{dir}/ss_out_flat_quadratic_{time}_{burn_in}_{num_unadjusted_steps}_{numsteps}_{j_r}.npy', ss_out)
    np.save(f'{dir}/var_errors_flat_quadratic_{time}_{burn_in}_{num_unadjusted_steps}_{numsteps}_{j_r}.npy', var_errors)
